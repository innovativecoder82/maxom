...
<body>
  ...
  <div class="container">
        <div class="card card-container">
            <img width="100%" src="images/Maxmo logo.png" />
			<form method="post" class="form-signin">
                <span id="reauth-email" class="reauth-email"></span>
                <input type="name" name="email" id="inputEmail" class="form-control" placeholder="User Name" required autofocus>
                <input type="password" name="password"id="inputPassword" class="form-control" placeholder="Password" required>
				<select name="role" class="browser-default custom-select form-control">
