	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">View Employee Daily Report</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Employee Daily Report</a>
							</li>
						</ul>
					</div>
		 ...
		 if(($adsessrole=='Admin') or ($adsessrole=='HR')){
					$query2 = mysqli_query($conn,"select count(emp_id), emp_id, emp_name from customer_details where date='$date' group by emp_id");
		 }else{
					$query2 = mysqli_query($conn,"select count(emp_id), emp_id, emp_name from customer_details where emp_id='$adsession' and date='$date' group by emp_id");
				...
				?>
												<tr>
													...
													<td><a href="view_emp_cus_details.php?empid=<?php echo $row['emp_id'];?>"><?php echo $row['count(emp_id)']; ?></a></td>
