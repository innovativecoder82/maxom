				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Select Project</h2>
							</div>
					...
					<div class="row">
						...
						<div class="card-body">
								 <form method="post">
										...
										<div class="container" >
											<div>       
											<select data-placeholder="Select Project..." onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" class="chzn-select" style="width:350px;" tabindex="2">
											<option value=""></option> 
											<?php 
												if(($emp_idro=='Admin') or ($emp_idro=='HR')){
		
												$sql = mysqli_query($conn,"SELECT * FROM project_details order by id asc");
												}
												else{ 
												$sql = mysqli_query($conn,"SELECT * FROM project_details  order by id asc");
											...
											$project_id=$rowsqq['id'];
											$project_id1=$rowsqq['project_id'];
											$project_name=$rowsqq['project_name'];
											?>
											<option value="view_plots1.php?Pr_id=<?php echo "$project_id";?>&&page=<?php echo 2;?>"><?php echo "$project_name - $project_id1";?></option>
											<?php }?>	
											</select>
											</div>
											</div>
