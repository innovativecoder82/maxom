...
<body>
	<div class="wrapper">
		<?php navbar('view_daily_report'); ?>

		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">View Daily Report</h4>
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Employee Name</th>
													<th>Customer Id</th>
													<th>First Meet Date</th>
													<th>Second Meet Date</th>
		 ...
		 if(($adsessrole=='Admin') or ($adsessrole=='HR')){
					...
					{
						$empid=$rowaa['emp_id'];
								$query2aa = mysqli_query($conn,"select * from customer_details where emp_id='$empid' and date='$date' order by id DESC");
							$row = mysqli_fetch_array($query2aa);
