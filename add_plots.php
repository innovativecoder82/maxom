				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Add Plots</h2>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="add_project.php" class="btn btn-secondary btn-round">Add Plots</a>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Add New Plots</div>
								</div>
								<div class="card-body">
								 <form method="post">
									<div class="row">
				  ...
				  ?>
				  	<input type="hidden" class="form-control" name="project_id1" value="<?php echo $project_id;?>" placeholder="Enter Code">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label for="email2">No of Plot</label>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label for="email2">Square Fiet</label>
												<input type="text" class="form-control" id="square_fiet" name="square_fiet" placeholder="Enter Square Fiet">
											</div>
