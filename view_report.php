...
if(($adsessrole=='Admin')or($adsessrole=='HR'))
		 ...
		 if (isset($_POST['submit'])) {
									...
									{
									$query2 = mysqli_query($conn,"select * from employee_details where  date BETWEEN '$from_date' AND '$to_date' order by id DESC");
									}
								}else{
									...
									if(($from_date!='')AND($to_date!=''))
									{
									$query2 = mysqli_query($conn,"select * from employee_details where (officer='$adsession' or emp_id='$adsession') and date BETWEEN '$from_date' AND '$to_date' order by id DESC");
									}
								}else{
									$query2 = mysqli_query($conn,"select * from employee_details where officer='$adsession' or emp_id='$adsession' order by id DESC");
								}
...
if(($adsessrole=='Admin')or($adsessrole=='HR'))
		 ...
		 if (isset($_POST['submit'])) {
									...
									if(($from_date!='')AND($to_date!=''))
									{
									$query2 = mysqli_query($conn,"select * from employee_details where  date BETWEEN '$from_date' AND '$to_date'");
									}
								}else{
									$query2 = mysqli_query($conn,"select * from employee_details ");
								}
									}else {
									 if (isset($_POST['submit'])) {
									$from_date=$_POST['from_date'];
									...
									if(($from_date!='')AND($to_date!=''))
									{
									$query2 = mysqli_query($conn,"select * from employee_details where (officer='$adsession' or emp_id='$adsession') and date BETWEEN '$from_date' AND '$to_date' ");
									}
								}else{
									$query2 = mysqli_query($conn,"select * from employee_details where officer='$adsession' or emp_id='$adsession'");
								}
					...
					{
							$empid=$row['emp_id'];
								$query2aa = mysqli_query($conn,"select * from customer_details where emp_id='$empid' order by date DESC");
				...
				?>
												<tr>
													<td nowrap="nowrap"><?php if($rowaa['date']>0){echo date('d-m-Y', strtotime($rowaa['date']));} else { } ?></td>
